...
<body class="hold-transition skin-blue sidebar-mini">
	...
	<div class="wrapper">
		...
		<div class="content-wrapper">
			...
			<form action="${pageContext.request.contextPath}/member/save.do"
				method="post">
				<!-- 正文区域 -->
					...
					<div class="row data-type">
						...
						<div class="col-md-4 data">
							<input type="text" class="form-control" name="name"
								placeholder="会员用户名" value="${member.name}" readonly>
						</div>
						<div class="col-md-2 title">昵称</div>
						<div class="col-md-4 data">
							<input type="text" class="form-control" name="nickname"
								placeholder="昵称" value="${member.nickname}" readonly>
						</div>
						<div class="col-md-2 title">联系电话</div>
						<div class="col-md-4 data">
							<input type="text" class="form-control" name="phoneNum"
								   placeholder="联系电话" value="${member.phoneNum}" readonly>
						</div>
						<div class="col-md-2 title">创建时间</div>
						<div class="col-md-4 data">
							<input type="text" class="form-control" name="phoneNum"
								   placeholder="创建时间" value="${member.createTimeStr}" readonly>
						</div>
						<div class="col-md-2 title">邮箱</div>
						<div class="col-md-4 data">
							<input type="text" class="form-control" name="email"
								placeholder="邮箱" value="${member.email}" readonly>
						</div>
				...
				<div class="panel panel-default">
						<div class="panel-heading">家庭游客信息</div>
					<!--数据列表-->
					<table id="dataList"
						...
						<c:forEach items="${member.travellers}" var="traveller" varStatus="var">
							<tr>
