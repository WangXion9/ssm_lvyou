...
<body class="hold-transition skin-blue sidebar-mini">
	...
	<div class="wrapper">
		...
		<div class="content-wrapper">
			...
			<h1>
				订单管理 <small>${product.productName} 新建订单</small>
			</h1>
			<ol class="breadcrumb">
			...
			<section class="content">
				<form id="sub" action="${pageContext.request.contextPath}/product/saveOrderByProductId.do"  method="post">
					<!--订单信息-->
						...
						<div class="row data-type">
							...
							<div class="col-md-4 data">
								<input type="text" class="form-control"
									   placeholder="产品编号" value="${product.productNum}"  disabled="disabled">
							</div>
							<div class="col-md-2 title">产品名称</div>
							<div class="col-md-4 data">
								<input type="text" class="form-control"
									   placeholder="产品名称" value="${product.productName}"  disabled="disabled">
							</div>
							...
							<div class="col-md-4 data">
								<div class="input-group date">
									...
									<input type="text" class="form-control pull-right"
										   id="datepicker-a3"  value="${product.departureTimeStr}"  disabled="disabled">
								</div>
							</div>
								...
								<div class="col-md-4 data">
									<input type="text" class="form-control" placeholder="出发城市"
										   value="${product.startCity.cityName}"  disabled="disabled">
								</div>

								<div class="col-md-2 title">目的城市</div>
								<div class="col-md-4 data">
									<input type="text" class="form-control" placeholder="目的城市"
										   value="${product.endCity.cityName}"  disabled="disabled">
								</div>
							...
							<div class="col-md-4 data">
								<select class="form-control select2" style="width: 100%"
										 id="selectStatus"  disabled="disabled">
							...
							<textarea class="form-control" rows="3" placeholder="其他信息"
									    disabled="disabled">${product.productDesc}</textarea>
							</div>
	...
	<script>
        ...
        //保存提交表单
        function saveAll() {
            if (checkName()&&checkNickName()&&checkPhone()&&checkEmail()&&checkOrderNum()&&checkManNum()&&checkDesc()&&checkSelect()){
                $("#sub").submit();
            } else {
                alert("表单请填写完整!");
            }
