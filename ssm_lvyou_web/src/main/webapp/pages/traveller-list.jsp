...
<body class="hold-transition skin-blue sidebar-mini">
	...
	<div class="wrapper">
		...
		<div class="content-wrapper">
			...
			<h1>
				游客管理 <small>全部游客</small>
			</h1>
			<ol class="breadcrumb">
				<li><a href="${pageContext.request.contextPath}/index.jsp"><i
						class="fa fa-dashboard"></i> 首页</a></li>
				<li><a
					href="${pageContext.request.contextPath}/user/findAll.do">游客管理</a></li>

				<li class="active">全部游客</li>
			</ol>
			</section>
			<!-- 内容头部 /-->
				...
				<div class="box box-primary">
					...
					<div class="box-footer">
						...
						<div class="box-tools pull-right">
							<ul class="pagination">
								<li><a href="${pageContext.request.contextPath}/traveller/findAll.do?page=1&size=${pageInfo.pageSize}&title=${title}" aria-label="Previous">首页</a></li>
								<li><a href="${pageContext.request.contextPath}/traveller/findAll.do?page=${pageInfo.pageNum - 1}&size=${pageInfo.pageSize}&title=${title}">上一页</a></li>
								<c:forEach begin="1" end="${pageInfo.pages}" var="pageNum">
									<c:if test="${pageInfo.pageNum == pageNum}">
										<li ><a style="background-color: #0d6aad;color: #FFF" href="${pageContext.request.contextPath}/traveller/findAll.do?page=${pageNum}&size=${pageInfo.pageSize}&title=${title}">${pageNum}</a></li>
									</c:if>
									<c:if test="${pageInfo.pageNum != pageNum}">
										<li ><a href="${pageContext.request.contextPath}/traveller/findAll.do?page=${pageNum}&size=${pageInfo.pageSize}&title=${title}">${pageNum}</a></li>
									</c:if>
								</c:forEach>
								<li><a href="${pageContext.request.contextPath}/traveller/findAll.do?page=${pageInfo.pageNum + 1}&size=${pageInfo.pageSize}&title=${title}">下一页</a></li>
								<li><a href="${pageContext.request.contextPath}/traveller/findAll.do?page=${pageInfo.pages}&size=${pageInfo.pageSize}&title=${title}" aria-label="Next">尾页</a></li>
							</ul>
						</div>
	...
	<script type="text/javascript" src="../js/jsUtils.js"></script>
		<script>
            ...
            function searchLike(){
                ...
                location.href="${pageContext.request.contextPath}/traveller/findAll.do?size=${pageInfo.pageSize}&title="+text;
            }
