	...
	<div class="wrapper">
		...
		<div class="content-wrapper">
			...
			<ol class="breadcrumb">
				...
				<li class="active">游客信息添加</li>
			</ol>
			</section>
			<!-- 内容头部 /-->

			<form id="form" action="${pageContext.request.contextPath}/traveller/save.do"
				method="post">
				<!-- 正文区域 -->
				<section class="content"> <!--产品信息-->

				<div class="panel panel-default">
					<div class="panel-heading">游客信息添加</div>
					<div class="row data-type">

						<div class="col-md-2 title">游客姓名</div>
						<div class="col-md-4 data">
							<input type="text" class="form-control checkName" name="name"
								placeholder="游客姓名" value="" onblur="checkName()">
						</div>
						<div class="col-md-2 title">联系电话</div>
						<div class="col-md-4 data">
							<input type="text" class="form-control checkPhone" name="phoneNum"
								   placeholder="联系电话 11位" value="" onblur="checkPhone()">
						</div>
						<div class="col-md-2 title">性别</div>
						<div class="col-md-4 data">
							<select class="form-control select2 checkSex" style="width: 100%"
									name="sex" >
						...
						<div class="col-md-4 data">
							<input type="text" class="form-control checkNum" name="credentialsNum"
								   placeholder="证件号码" value="" onblur="checkNum()">
						</div>
	...
	<script>
        ...
        function checkName() {
            ...
            if("" == username){
                ...
                var flag;
                $.get({
                    url:"${pageContext.request.contextPath}/traveller/findTravellerByTravellerName.do?name="+username,
                    dataType:"json",
                    async:false,
