                        ...
                        <div class="tab-pane active" id="tab-form">
                            <div class="row data-type">
                                ...
                                <div class="col-md-10 data">
                                    <select class="form-control select2 checkProductId" style="width: 100%"
                                            name="product.id">
                                ...
                                <div class="col-md-10 data">
                                    <select class="form-control select2 checkMemberId" style="width: 100%"
                                            name="member.id">
                                        <option value="" selected="selected">请选择</option>
                                ...
                                <div class="col-md-10 data">
                                    <input type="text" class="form-control checkLike" name="likeCount"
                                           placeholder="点赞数" value="" onblur="checkLike()">
                                </div>

                                <div class="col-md-2 title">收藏数</div>
                                <div class="col-md-10 data">
                                    <input type="text" class="form-control checkCollect" name="collect"
                                           placeholder="收藏数" value="" onblur="checkCollect()">
                                </div>


                                <div class="col-md-2 title">显示状态</div>
                                <div class="col-md-10 data">
                                    <select name="showStatus" class="form-control checkShowStatus">
                                ...
                                <div class="col-md-10 data">
                                <select name="diaryStatus" class="form-control checkDiaryStatus">
                                    <option value="">请选择</option>
                            ...
                            <div class="panel panel-default">
                                ...
                                <div id="dayslist" class="panel-body">
                                    ...
                                    <div class="box box-success">
                                        ...
                                        <div class="box-body">
                                            <input name="title" type="text" class="form-control checkTitle" placeholder="第xx天游记标题" value="" onblur="checkTitle()"><br>
                                            <textarea name="texts" class="textarea checkT" placeholder="第xx天游记正文"  style="width: 100%; height: 265px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;" onblur="checkT()"></textarea>
                                        </div>
                                    </div>
...
<script>
    ...
    function checkTitle() {
        ...
        if("" == username){
            ...
            var flag;
            $.get({
                url:"${pageContext.request.contextPath}/diary/findDiaryByDiaryTitle.do?name="+username,
                dataType:"json",
                async:false,
