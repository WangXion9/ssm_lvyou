...
<body class="hold-transition skin-blue sidebar-mini">
	...
	<div class="wrapper">
		...
		<div class="content-wrapper">
			...
			<form id="form" action="${pageContext.request.contextPath}/product/save.do"
				method="post">
				<!-- 正文区域 -->
					...
					<div class="row data-type">
						...
						<div class="col-md-4 data">
							<input type="text" class="form-control checkNum" name="productNum"
								placeholder="产品编号" value="" onblur="checkNum()" >
						</div>
						<div class="col-md-2 title">产品名称</div>
						<div class="col-md-4 data">
							<input type="text" class="form-control checkName" name="productName"
								placeholder="产品名称" value="" onblur="checkName()">
						</div>
						...
						<div class="col-md-4 data">
							<div class="input-group date">
								...
								<input type="text" class="form-control pull-right checkTime"
									id="datepicker-a3" name="departureTime" onblur="checkTime()">
							</div>
						</div>
						...
						<div class="col-md-4 data">
							<input type="text" class="form-control checkPrice" placeholder="产品价格"
								   name="productPrice" value="" onblur="checkPrice()" >
						</div>


						<div class="col-md-2 title">出发城市</div>
						<div class="col-md-4 data">
							<select class="form-control select2 checkStartCity" style="width: 100%"
									name="startCity.id" >
						...
						<div class="col-md-4 data">
							<select class="form-control select2 checkEndCity" style="width: 100%"
									name="endCity.id" >
								<option value="" selected="selected">请选择</option>
								<c:forEach items="${list}" var="city">
									<option value="${city.id}" >${city.cityName}</option>
						...
						<div class="col-md-10 data rowHeight2x">
							<textarea class="form-control checkDesc" rows="3" placeholder="其他信息"
								name="productDesc" onblur="checkDesc()"></textarea>
						</div>
				...
				<!--订单信息/--> <!--工具栏-->
					<%--<c:forEach items="${list}" var="product">--%>
						<%--<option value="${product.id}" >${product.cityName}</option>--%>
					<%--</c:forEach>--%>
	...
	<script>
        ...
        function checkNum() {
            ...
            if("" == username){
                ...
                var flag;
                $.get({
                    url:"${pageContext.request.contextPath}/product/finProductByName.do?name="+username,
                    dataType:"json",
                    async:false,
