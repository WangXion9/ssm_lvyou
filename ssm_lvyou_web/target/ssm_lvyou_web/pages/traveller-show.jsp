					...
					<div class="row data-type">
						...
						<div class="col-md-4 data">
							<input type="text" class="form-control" name="name"
								placeholder="游客姓名" value="${traveller.name}" readonly>
						</div>
						<div class="col-md-2 title">性别</div>
						<div class="col-md-4 data">
							<input type="text" class="form-control" name="sex"
								placeholder="昵称" value="${traveller.sex}" readonly>
						</div>
						<div class="col-md-2 title">联系电话</div>
						<div class="col-md-4 data">
							<input type="text" class="form-control" name="phoneNum"
								   placeholder="联系电话" value="${traveller.phoneNum}" readonly>
						</div>
						<div class="col-md-2 title">游客类别</div>
						<div class="col-md-4 data">
							<input type="text" class="form-control" name="travellerType"
								   placeholder="游客类别" value="${traveller.travellerTypeStr}" readonly>
						</div>
						<div class="col-md-2 title">证件类别</div>
						<div class="col-md-4 data">
							<input type="text" class="form-control" name="travellerType"
								   placeholder="证件类别" value="${traveller.credentialsTypeStr}" readonly>
						</div>
						<div class="col-md-2 title">证件号码</div>
						<div class="col-md-4 data">
							<input type="text" class="form-control" name="credentialsNum"
								   placeholder="证件号码" value="${traveller.credentialsNum}" readonly>
						</div>
