...
<body class="hold-transition skin-blue sidebar-mini">
	...
	<div class="wrapper">
		...
		<div class="content-wrapper">
			...
			<form id="form" action="${pageContext.request.contextPath}/member/save.do"
				method="post">
				<!-- 正文区域 -->
