...
<link rel="stylesheet"
	...
	<div class="wrapper">
		...
		<div class="content-wrapper">
			...
			<form id="form" action="${pageContext.request.contextPath}/role/save.do"
				method="post">
				<!-- 正文区域 -->
				...
				<div class="panel panel-default">
					...
					<div class="row data-type">
						...
						<div class="col-md-4 data">
							<input id="cname" type="text" class="form-control checkName" name="roleName"
								placeholder="角色名称" value="" onblur="checkName()">
						</div>
						<div class="col-md-2 title">角色描述</div>
						<div class="col-md-4 data">
							<input  type="text" class="form-control checkDesc" name="roleDesc"
								placeholder="角色描述" value="" onblur="checkDesc()">
						</div>
	...
	<script>
        ...
        function checkName() {
            ...
            if("" == username){
                ...
                var flag;
                $.get({
					url:"${pageContext.request.contextPath}/role/findRoleByRoleName.do?name="+username,
					dataType:"text",
                    async:false,
